...
export const CSR = [
  {
    ...
    text: 'Rest facilities at major branches, health camps, and education support for drivers’ children.',
  },
  {
    icon: 'shield',
    title: 'Road Safety Education',
    text: 'Defensive-driving and fatigue-management workshops run for our drivers and for local transport communities.',
  },
  {
    icon: 'leaf',
